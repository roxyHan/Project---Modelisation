...
public class CallgraphFactoryImpl extends EFactoryImpl implements CallgraphFactory {
	...
	public static CallgraphFactory init() {
		try {
			CallgraphFactory theCallgraphFactory = (CallgraphFactory)EPackage.Registry.INSTANCE.getEFactory(CallgraphPackage.eNS_URI);
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case CallgraphPackage.CALL_GRAPH: return createCallGraph();
			case CallgraphPackage.NODE: return createNode();
			case CallgraphPackage.EDGE: return createEdge();
			default:
